...
function Cart() {
  ...
  const shipping = totalAmout >= 300 ? 0 : 100;
  const grandTotal = shipping + totalAmout;

  /**========================================================================
   *!                           Payment Integration and COD Option
   *========================================================================**/
  ...
  // Function to handle order completion for both Online and COD
  const placeOrder = async (paymentId = "COD") => {
    const orderInfo = {
      cartItems,
  ...
  const buyNow = () => {
    ...
    if (paymentMethod === "COD") {
      // If Cash on Delivery is selected, place the order directly
      placeOrder();
    } else {
      ...
      const options = {
        ...
        name: "SV ReadyMades and General Stores",
            ...
            {cartItems.map((item, index) => (
              ...
              >
                ...
                <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                  ...
                  <div onClick={() => deleteCart(item)} className="mt-4 flex justify-between sm:mt-0 sm:block">
