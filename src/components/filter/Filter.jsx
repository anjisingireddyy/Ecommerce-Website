...
function Filter() {
    ...
    // Apply filtering based on selected category and price
    React.useEffect(() => {
        ...
        // Update filtered products (assuming setFilteredProducts exists in context)
        // This will be used to update your displayed product list if you have such logic
                ...
                <div className="p-5 rounded-lg bg-gray-100 drop-shadow-xl border border-gray-200"
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <button
                            ...
                            onClick={() => {
                                setFilterType("");  // Reset category filter
                                setFilterPrice("");  // Reset price filter
                            }}>
                            {/* Reset Filter */}
                        </button>
                    </div>
